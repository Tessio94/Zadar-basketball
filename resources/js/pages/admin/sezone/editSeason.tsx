...
import type { Season, SeasonForm } from '@/types/propTypes';
...
export default function EditSeason({ season }: { season: Season }) {
    const { data, setData, put, processing, errors } = useForm<SeasonForm>({
        name: season.name || '',
...
EditSeason.layout = (page: React.ReactNode) => (
