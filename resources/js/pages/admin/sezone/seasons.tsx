...
import type { Paginated, Season } from '@/types/propTypes';
import {
    create,
    destroy,
    edit,
...
export default function Seasons({ seasons }: { seasons: Paginated<Season> }) {
    return (
        <>
            <Head title="Admin panel | Sezone" />
            <AdminMainContent>
                <div className="flex min-h-full flex-col justify-between">
                    <div className="mb-4 flex justify-between">
                        <h1 className="text-xl font-bold">Sezone</h1>
                    ...
                    <div className="flex flex-row justify-center">
                        <Pagination links={seasons.links} type="admin" />
                    </div>
                </div>
            </AdminMainContent>
        </>
...
Seasons.layout = (page: React.ReactNode) => (
