...
export default function Info() {
    return (
        <section className="relative h-[1559px] w-full bg-[url(/images/design/main-bg2-mb.png)] bg-cover bg-no-repeat min-[890px]:h-[1368px] min-[890px]:bg-[url(/images/design/main-bg2.png)]">
